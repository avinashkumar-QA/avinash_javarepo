...
public class Set_to_TreeSet {
	...
	//	Set1.add(1.78); //Heterogeneous allowed
		...
		Set1.remove(7); // We can remove by entering the value not index value. but it will deleted unique and duplicate but in case of duplicate any one can remove..
...
//		System.out.println("Removed all value from array Set1: " + Set1);
		...
		boolean b1= Set2.contains(8); // Check all words not a single word present or not.
